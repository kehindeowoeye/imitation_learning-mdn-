...
dataset = np.array(pd.read_excel('vv11111.xlsx',header=None))
...
model_move.save('m12')
"""
model_json = model_stay.to_json()
with open("model.json", "w") as json_file:
    json_file.write(model_json)
# serialize weights to HDF5
model_stay.save_weights("model_stay.h5")
"""

#save_load_utils.save_all_weights(model_Stay,'modstay')
