...
dataset = np.array(pd.read_excel('vv101.xlsx',header=None))
...
history = model.fit(x_train_reshaped2, one_hot_labels2, epochs=n_epoch, batch_size=1, verbose=2,validation_split = 0.1,callbacks=callbacks_list)
