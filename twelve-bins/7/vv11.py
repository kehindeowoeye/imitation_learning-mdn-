...
filepath="weights-improvement2-{epoch:02d}-{loss:.2f}.hdf5"
...
history = model_move.fit(Xtrain1, labeltrain1, batch_size=n_batch, nb_epoch=n_epoch, verbose=1,callbacks=callbacks_list)
