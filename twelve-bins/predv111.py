...
dataset = np.array(pd.read_excel('vv111.xlsx',header=None))
...
model = Sequential()
model.add(LSTM(n_neurons, input_shape=(None, 34*4), activation = 'relu', return_sequences=True))
